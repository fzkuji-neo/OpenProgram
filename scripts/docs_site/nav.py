...
TAB_SECTIONS: dict[str, list[tuple[str, str, list[str]]]] = {
    ...
    "design": [
        ...
        ('Runtime · Execution', '运行时 · 执行与控制', [
            ...
            "reference/design/runtime/execution/execution-control.html",
        ...
        ('Runtime · DAG and collaboration', '运行时 · DAG 与协作', [
            ...
            "reference/design/runtime/dag/dag-layout-spec.html",
        ...
        ('Context', '上下文', [
            ...
            "reference/design/context/context-compaction.html",
            "reference/design/context/occupancy-status.html",
            "reference/design/context/context-statistics.html",
        ...
        ('Memory', '记忆', [
            ...
            "reference/design/memory/memory-adoption.html",
            "reference/design/memory/memory-comparison.html",
            "reference/design/memory/memory-editor.html",
            "reference/design/memory/memory-settings-ui.html",
        ...
        ('Events and scheduling', '事件与调度', [
            ...
            "reference/design/scheduler/scheduler-memory.html",
        ]),
