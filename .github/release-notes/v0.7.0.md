...
- **macOS**
  - **Package installation**
    - Apple Silicon (M-series): [Download DMG](https://github.com/fzkuji-neo/OpenProgram/releases/download/v0.7.0/OpenProgram-0.7.0-mac-arm64-unsigned.dmg) or [download ZIP](https://github.com/fzkuji-neo/OpenProgram/releases/download/v0.7.0/OpenProgram-0.7.0-mac-arm64-unsigned.zip)
    - Intel: [Download DMG](https://github.com/fzkuji-neo/OpenProgram/releases/download/v0.7.0/OpenProgram-0.7.0-mac-x64-unsigned.dmg) or [download ZIP](https://github.com/fzkuji-neo/OpenProgram/releases/download/v0.7.0/OpenProgram-0.7.0-mac-x64-unsigned.zip)
...
- Complete asset inventory: [release-manifest.json](https://github.com/fzkuji-neo/OpenProgram/releases/download/v0.7.0/release-manifest.json)

See the [Desktop and built-in browser documentation](https://openprogram.io/docs/interfaces/desktop.html), the [installation documentation](https://openprogram.io/docs/install/install.html), and the [v0.7.0 commit history](https://github.com/fzkuji-neo/OpenProgram/commits/v0.7.0) for more information.
