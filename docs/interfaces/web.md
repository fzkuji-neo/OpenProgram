...
The floating webpage preview fills the space below its compact header, without an outer frame or side and bottom padding. Drag the header to move it; use its edges or corners to resize it.
